            ...
            <form action="" method="post" style="background-color: darkgray;">
                    ...
                    <div class="col-sm-8">
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-4">Marca
                                <input type="text" class="form-control" style="border-radius: 25px;" name="txtMarca" id="txtMarca">
                            </div>
                            <div class="col-sm-4">Quantidade
                                <input type="text" class="form-control" style="border-radius: 25px;" name="txtQuantidade" id="txtQuantidade">
                            </div>
                        </div>
                        <div class="row mt-3 ">
                            <div class="col-sm-4">Valor unitario
                                <input type="text" class="form-control" style="border-radius: 25px;" name="txtValorunitario" id="txtValorunitario">
                            </div>
                            <div class="col-sm-4">Valor custo
                                <input type="text" class="form-control" style="border-radius: 25px;" name="txtValorcusto" id="txtValorcusto">
                            </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-3">Altura (cm)
                        <input type="text" class="form-control" style="border-radius: 25px;" name="txtAltura" id="txtAltura">
                    </div>
                    <div class="col-sm-3">Largura (cm)
                        <input type="text" class="form-control" style="border-radius: 25px;" name="txtlargura" id="txtlargura">
                    </div>
                    <div class="col-sm-3">Comprimento (cm)
                        <input type="text" class="form-control" style="border-radius: 25px;" name="txtComprimento" id="txtComprimento">
                    </div>
