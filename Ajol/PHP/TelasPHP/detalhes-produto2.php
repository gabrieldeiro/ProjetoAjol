            ...
            <div class="col-sm-8 bg-white p-3 mt-4" style="border-radius: 5px;">
                <div class="col-sm-12">
                    <div class="col-sm-2 mt-4">
                        <p>
                            <a href="detalhes-produto.php?id=<?=$_GET['id']?>"><img src="../../img/prod/<?= $idProduto ?>/<?= $imgProduto ?>" class="img-thumbnail w-75" alt=""></a>
                        </p>
                        <p>
                    ...
                    <div class="col-sm-6">
                        <img src="../../img/prod/<?= $idProduto ?>/<?= $img2Produto ?>" class="w-100 img-fluid" alt="">
                    </div>
